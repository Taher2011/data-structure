...
public class CustomLinkedList<T> {
	...
	public static void main(String[] args) {
		CustomLinkedList<String> cl = new CustomLinkedList<String>();
		cl.addLast("W");
		cl.addFirst("R");
		cl.addFirst("E");
		cl.addFirst("B");
		...
		cl.add("E");
		System.out.println(cl);
		System.out.println(cl.remove("C"));
		System.out.println(cl);
		System.out.println(cl.getFirst());
		System.out.println(cl.getLast());
		System.out.println(cl.remove("D"));
		System.out.println(cl);
		cl.removeLast();
		System.out.println(cl);
		...
		cl.addFirst("A");
		System.out.println(cl);
		System.out.println(cl.remove("W"));
		System.out.println(cl);
		System.out.println(cl.remove("B"));
		System.out.println(cl);
		System.out.println(cl.remove(1));
		System.out.println(cl);
		cl.removeLast();
